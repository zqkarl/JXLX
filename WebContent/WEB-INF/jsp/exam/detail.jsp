       ...
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-12">
                        <p class="col-lg-3">考试科目：${fn:subjectName(exam.subjectId) }</p>
                        <p class="col-lg-3">考试年级：${fn:gradeName(exam.gradeId)}</p>
                        <p class="col-lg-3">考试时间：${exam.examStartTime }</p>
                    </div>
                </div>
                ...
                <div class="row">
                	<div class="col-lg-12">
						...
						<tbody>
							...
							<tr>
								<td><c:out value="${score.studentId}"/></td>
								<td><c:out value="${fn:studentName(score.studentId)}"/></td>
                		...
                		<div class="panel panel-info">
							...
							<thead>
								<tr>
									...
									<th>姓名</th>
									<th>班级</th>
									<th class="col-lg-1">考试成绩</th>
									<th class="col-lg-6">教师评价</th>
									<th class="col-lg-1">保存</th>
								</tr>
							</thead>
						<tbody>
						
							<c:forEach items="${studentList}" var="student">
							<form action="${pageContext.request.contextPath}/score/detail/add" method="post">
							<tr>
								<input type="hidden" name="examId" value="${exam.id }">
								<td><c:out value="${student.id}"/><input type="hidden" name="studentId" value="${student.id}"></td>
								<td><c:out value="${student.studentName}"/></td>
								<td><c:out value="${fn:className(student.classId)}"/></td>
								<td><input class="form-control" name="score"></td>
								<td><input class="form-control" name="teacherComment"></td>
								<td><button class="btn btn-sm btn-info">保存</button></td>	
							</tr>
							</form>
							</c:forEach>
