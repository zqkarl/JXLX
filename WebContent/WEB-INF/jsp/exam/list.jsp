                ...
                <div class="row">
                    <div class="col-lg-8 ">
						...
						<tbody>
							...
							<tr>
								<td>${exam.id }</td>
								<td>${fn:subjectName(exam.subjectId) }</td>
								<td>${fn:gradeName(exam.gradeId) }</td>
								<td>${exam.examStartTime }</td>
								<td><a href="${pageContext.request.contextPath}/exam/${exam.id}/detail">查看</a></td>
							</tr>
							</c:forEach>
					...
					<button type="button" class="btn btn-primary" id="addButton" style="float:right;width:10%；margin-left:3%">新增考试</button>
					</a>
                    </div>
               		<div class="col-lg-4">
               			<div class="panel panel-warning">
                            ...
                            <div class="panel-body">
					            ...
					            <div class="form-group col-md-12">
					                <label for="titleKey" class="control-label">科目筛选</label>
					                <select class="form-control" name="subjectId" id="subjectId" >
					                <option selected="selected" value="">--请选择科目--</option>
					            ...
					            <div class="form-group col-md-12">
					                <label for="titleKey" class="control-label">年级筛选</label>
					            ...
					            <div class="form-group col-md-12">
					                <label for="fromDate" class="control-label">选择考试时间</label>
